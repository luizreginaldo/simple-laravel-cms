        ...
        <x-slot name="content">
            ...
            <div class="mt-4">
                <label for="isSetToDefaultHomePage">
                    <input id="isSetToDefaultHomePage" class="form-checkbox" type="checkbox" value="{{ $isSetToDefaultHomePage}}" wire:model="isSetToDefaultHomePage">
                    <span class="ml-2 text-sm text-gray-600">Set as the default home page</span>
                </label>
            </div>
            <div class="mt-4">
                <label for="isSetToDefaultNotFoundPage">
                    <input id="isSetToDefaultNotFoundPage" class="form-checkbox" type="checkbox" value="{{ $isSetToDefaultNotFoundPage}}" wire:model="isSetToDefaultNotFoundPage">
                    ...
                    <div class="mt-1 bg-white">
                        <div class="body-content" wire:ignore>
                            <trix-editor
                                class="trix-content"
                                x-ref="trix"
                                wire:model.debounce.1000000ms="content"
